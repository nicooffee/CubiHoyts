...
public class PanelPeliculas1E1 extends JPanel{
	/**
	 * 
	 */
	...
	public PanelPeliculas1E1(Pelicula pel) {
		setLayout(null);
		setSize(800,600);
		setLabels();
		setCampos(pel);
	...
	public void setLabels() {
		...
		add(btnCantidad);
		add(campoCant);
		cantidad.setBounds(450, 400, 150,25);
		btnCantidad.setBounds(650, 400, 75, 25);
		campoCant.setBounds(560, 400, 75, 25);
		add(nombrePelicula);
		add(codigoPelicula);
